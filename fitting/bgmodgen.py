...
# bm = Model('po+gauss+gauss+gauss+gauss', 'back', 2)
# bm(1).values = 0.95
# bm(2).values = 1e-4
# bm(3).values = '2.0,0.01,1.8,1.8,2.2,2.2'
# bm(4).values = '0.001,0.001,0,0,0.01,0.01'
# bm(5).values = 1e-4
# bm(6).values = '8.5,0.01,8,8,9,9'
# bm(7).values = '0.001,0.001,0,0,0.01,0.01'
# bm(8).values = 1e-4
# bm(9).values = '1.5,0.01,1.3,1.3,1.7,1.7'
# bm(10).values = '0.001,0.001,0,0,0.1,0.1'
# bm(11).values = 1e-4
# bm(12).values = '5.5,0.01,5,5,6,6'
# bm(13).values = '0.001,0.001,0,0,0.1,0.1'
# bm(14).values = 1e-4
